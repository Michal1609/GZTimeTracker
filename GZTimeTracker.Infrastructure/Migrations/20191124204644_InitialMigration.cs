        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Privilegia = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Action",
                columns: new[] { "Id", "Description", "Entity", "Privilegia", "RoleEntityId" },
                values: new object[] { 1, "Full privilegia", "Project", "Full", null });

            migrationBuilder.InsertData(
                table: "Action",
                columns: new[] { "Id", "Description", "Entity", "Privilegia", "RoleEntityId" },
                values: new object[] { 2, "Only readign", "Project", "Read", null });

            migrationBuilder.InsertData(
                table: "Action",
                columns: new[] { "Id", "Description", "Entity", "Privilegia", "RoleEntityId" },
                values: new object[] { 3, "Full privilegia withou delete", "Project", "Update", null });
